...
class CompanyLead extends \Mautic\LeadBundle\Entity\CompanyLead implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'company', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'lead', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'dateAdded', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'manuallyRemoved', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'manuallyAdded', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\CompanyLead' . "\0" . 'primary');
        }
