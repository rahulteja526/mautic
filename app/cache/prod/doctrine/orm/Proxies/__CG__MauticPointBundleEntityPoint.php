 ...
 */
class Point extends \Mautic\PointBundle\Entity\Point implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'id', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'name', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'description', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'type', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'delta', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'properties', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'log', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'category', 'changes', 'new', 'deletedId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Point $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addLog(\Mautic\PointBundle\Entity\LeadPointLog $log)
    {
     ...
     * {@inheritDoc}
     */
    public function removeLog(\Mautic\PointBundle\Entity\LeadPointLog $log)
    {
    ...
    public function getDelta()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDelta', array());
    ...
    public function setDelta($delta)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDelta', array($delta));
