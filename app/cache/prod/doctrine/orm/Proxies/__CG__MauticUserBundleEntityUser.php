...
class User extends \Mautic\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'password', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'currentPassword', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'position', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'timezone', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'locale', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'lastLogin', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'lastActive', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'onlineStatus', 'isGuest', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'activePermissions', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'preferences', '' . "\0" . 'Mautic\\UserBundle\\Entity\\User' . "\0" . 'signature', 'changes', 'new', 'deletedId');
        }
