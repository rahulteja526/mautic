...
class LeadNote extends \Mautic\LeadBundle\Entity\LeadNote implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadNote' . "\0" . 'id', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadNote' . "\0" . 'lead', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadNote' . "\0" . 'text', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadNote' . "\0" . 'type', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadNote' . "\0" . 'dateTime', 'changes', 'new', 'deletedId');
        }
