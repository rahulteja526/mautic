...
class Campaign extends \Mautic\CampaignBundle\Entity\Campaign implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'id', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'name', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'description', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'category', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'events', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'leads', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'lists', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'forms', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Campaign' . "\0" . 'canvasSettings', 'changes', 'new', 'deletedId');
        }
