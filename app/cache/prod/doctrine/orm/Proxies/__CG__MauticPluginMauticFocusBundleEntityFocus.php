...
class Focus extends \MauticPlugin\MauticFocusBundle\Entity\Focus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'id', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'description', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'name', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'category', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'type', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'website', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'style', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'publishUp', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'publishDown', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'properties', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'form', '' . "\0" . 'MauticPlugin\\MauticFocusBundle\\Entity\\Focus' . "\0" . 'cache', 'changes', 'new', 'deletedId');
        }
