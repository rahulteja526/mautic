...
class Form extends \Mautic\FormBundle\Entity\Form implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'id', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'name', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'description', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'alias', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'category', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'cachedHtml', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'postAction', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'postActionProperty', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'fields', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'actions', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'template', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'inKioskMode', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'renderStyle', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'submissions', 'submissionCount', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'formType', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'usesProgressiveProfiling', 'changes', 'new', 'deletedId');
        }
